"""
Django settings for illegalai project.
...
SECRET_KEY = 'django-insecure-ftgt2(ekynl(a#8$5b39^y5okj8b5j@anx3@zmbp*dk(sv(yo$'
...
WSGI_APPLICATION = 'illegalai.wsgi.application'
